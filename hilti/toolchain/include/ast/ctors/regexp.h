...
public:
    ...
    static auto create(ASTContext* ctx, std::vector<std::string> v, const Meta& meta = {}) {
        return CtorPtr(
            new RegExp({QualifiedType::create(ctx, type::RegExp::create(ctx, meta), true)}, std::move(v), meta));
    }
